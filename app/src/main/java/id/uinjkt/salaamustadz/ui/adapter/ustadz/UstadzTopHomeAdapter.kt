...
import id.uinjkt.salaamustadz.databinding.ItemProfileHomeBinding
...
class UstadzTopHomeAdapter(
    private val context: Context,
    private val userUstadz: List<User>
) : RecyclerView.Adapter<UstadzTopHomeAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        return ViewHolder(
            ItemProfileHomeBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textSpecialize.text = if (item.additionalInfo?.knowledgeField.isNullOrEmpty()) "Umum" else item.additionalInfo?.knowledgeField?.joinToString(", ")
    ...
    inner class ViewHolder(binding: ItemProfileHomeBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        val textSpecialize: TextView = binding.txtSpecialize
    }
